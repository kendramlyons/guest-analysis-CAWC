...
stay_len_perc %>%
  ...
  xlim(0,50) +
  labs(x = "Stay Length in Days (0-50)", 
...
individuals %>%
  ...
  ggplot(aes(x = stay_length)) +
  geom_bar(fill = "orange", color = "purple", na.rm = TRUE) +
  xlim(-1, 30) +
  labs(x = "Stay Length in Days (0-30)", 
       y = "Number of Individuals")
```

## Stay Lenth Trends by Group Size
